...
import com.Backend.AI_Resume_Builder_Backend.user.UserPreference;
import com.Backend.AI_Resume_Builder_Backend.user.UserPreferenceService;
...
public class AgentController {
     ...
     */
    @PostMapping("/chat")
    public ResponseEntity<AgentChatResponse> chat(@RequestBody AgentChatRequest request, Authentication authentication) {
        String principalUserId = (authentication != null) ? authentication.getName() : request.getUserId();
        request.setUserId(principalUserId);
    ...
    public ResponseEntity<Map<String, Object>> batchImproveBullets(@Valid @RequestBody BatchImproveRequest request) {
    ...
    public ResponseEntity<Map<String, Object>> generateSummary(@Valid @RequestBody GenerateSummaryRequest request) {
        String jobTitle = request.getJobTitle();
        int yearsExp = request.getYearsExperience();
        String targetRole = request.getTargetRole();
    ...
    public ResponseEntity<Map<String, Object>> generateSkills(@Valid @RequestBody GenerateSkillsRequest request) {
        String targetRole = request.getTargetRole();
    ...
    public ResponseEntity<Map<String, Object>> getPreferences(
        ...
        String principalUserId = (authentication != null) ? authentication.getName() : userId;
        if (principalUserId == null || principalUserId.trim().isEmpty()) {
            return ResponseEntity.badRequest().body(Map.of("error", "userId is required"));
        }

        UserPreference pref = userPreferenceService.getPreferences(principalUserId);
        Map<String, Object> result = userPreferenceService.preferenceToMap(pref);
        result.put("userId", principalUserId);
    ...
    public ResponseEntity<Map<String, Object>> updatePreferences(
        ...
        UserPreference pref = userPreferenceService.savePreferences(principalUserId, updates);
        Map<String, Object> result = userPreferenceService.preferenceToMap(pref);
        result.put("userId", principalUserId);
    ...
    public ResponseEntity<Map<String, String>> deletePreferences(
        ...
        userPreferenceService.deletePreferences(principalUserId);
        return ResponseEntity.ok(Map.of("status", "deleted", "userId", principalUserId));
    }
    ...
    public ResponseEntity<List<Map<String, Object>>> getUserConversations(
        ...
        List<AgentConversation> conversations = agentChatService.getUserConversations(principalUserId);
    ...
    public ResponseEntity<Map<String, Object>> getConversation(
        ...
        List<AgentMessage> messages = agentChatService.getSessionMessages(sessionId, userId);
