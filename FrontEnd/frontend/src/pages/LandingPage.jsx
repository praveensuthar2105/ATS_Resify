  ...
  return (
    <div className="landing-page grid-bg font-mono uppercase bg-brutal-black text-brutal-white">
      <SEO
        ...
        href="https://atsresify.me/"
      />
      <Helmet>
        {/* WebSite schema — enables sitelinks searchbox in Google brand SERP */}
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "potentialAction": {
              ...
              "target": {
                "@type": "EntryPoint",
                "urlTemplate": "https://atsresify.me/ats-checker"
              },
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "description": "Free AI-powered resume builder and ATS checker. Generate ATS-optimized resumes and check your ATS score in seconds.",
            "aggregateRating": {
            ...
            "mainEntity": [
              {
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Yes! ATS Resify is completely free for generating resumes, checking ATS scores, and exporting high-quality PDFs. No credit card required."
                }
              },
              {
                "@type": "Question",
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Upload your resume PDF and our AI analyzes it against industry-standard ATS algorithms. You get a detailed score with keyword gap analysis, formatting checks, and actionable suggestions to improve your ranking."
                }
              },
              {
                "@type": "Question",
                "name": "Can I use ATS Resify to build a resume from scratch?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Absolutely. Just describe your experience and skills in plain text, and our AI generates a complete ATS-optimized resume in seconds. You can also import from a LinkedIn PDF or an existing resume."
                }
              },
              {
                "@type": "Question",
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "A resume is a concise 1-2 page document tailored for a specific job, common in the US and India. A CV (Curriculum Vitae) is a longer, comprehensive document used in academia and many international markets. ATS Resify generates ATS-optimized resumes suitable for most job applications."
                }
              }
            ]
          })}
          ...
          <div className="lg:col-span-5 p-12 bg-brutal-black flex items-center justify-center relative">
            <div className="w-full aspect-[3/4] brutal-border bg-black/40 relative overflow-hidden group shadow-2xl">
              ...
              <img
                ...
                alt="ATS-optimized resume preview generated by ATS Resify AI"
                width="604"
                height="807"
                fetchPriority="high"
                loading="eager"
