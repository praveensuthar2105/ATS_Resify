...
export const API_BASE_URL = import.meta.env.VITE_API_BASE_URL || (isLocalhost ? 'http://localhost:8080/api' : 'https://ats-resify-backend-692397969993.asia-south1.run.app/api');
